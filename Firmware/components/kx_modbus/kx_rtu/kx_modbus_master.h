...
// =============================================================
// kx_modbus_read_one / kx_modbus_write_one
//
// Estas dos funciones no tienen llamadores activos en el
// sistema actual. Su implementación se movió a
// kx_rtu/kx_modbus_legacy.c (bloque #if 0).
//
// Se mantienen aquí declaradas por compatibilidad de header,
// pero NO están implementadas — no enlazar si se usan.
// Si se necesitan, habilitar el bloque en kx_modbus_legacy.c
// y descomentar estas declaraciones.
// =============================================================
